    ...
    */
    ...
    'settings' => [
        ...
        'fields' => [
            ...
            'sms_enabled_help' => 'Toggle SMS sending via configured drivers',
            'sms_default_driver' => 'Default SMS Driver',
            'sms_default_driver_help' => 'Driver used when none is specified in toSms() payload',
            'sms_credentials_json' => 'SMS Credentials (JSON)',
            'sms_credentials_json_help' => 'Driver-keyed credentials, e.g. {"http_generic":{"token":"...","sender":"MySender"}}',
            'sms_credentials_json_placeholder' => '{"http_generic":{"token":"abc","sender":"Notify"}}',
            'wba_enabled' => 'Enable WhatsApp Business',
            'wba_enabled_help' => 'Toggle sending via WBA (wba-filament)',
        ...
        'errors' => [
            ...
            'invalid_sms_credentials' => 'Invalid SMS credentials JSON',
            'invalid_wba_credentials' => 'Invalid WBA credentials',
        ],
    ],
